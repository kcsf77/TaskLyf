...
// Sample data for AC maintenance services
const services = [
    { id: '1', name: 'Basic Maintenance', duration: '30 min', price: 50 },
    { id: '2', name: 'Deep Maintenance', duration: '60 min', price: 100 },
    { id: '3', name: 'Comprehensive Checkup', duration: '90 min', price: 150 },
    { id: '4', name: 'Filter Cleaning', duration: '45 min', price: 70 },
    { id: '5', name: 'Refrigerant Level Check', duration: '30 min', price: 60 },
];

const ACmaintenance = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>AC Maintenance Services</Text>
            </View>
