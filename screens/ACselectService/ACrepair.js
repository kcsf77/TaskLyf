...
const services = [
    { id: '1', name: 'Leak Repair', duration: '30 min', price: 100 },
    { id: '2', name: 'Compressor Replacement', duration: '120 min', price: 300 },
    { id: '3', name: 'Thermostat Repair', duration: '45 min', price: 80 },
    { id: '4', name: 'Electrical Issues', duration: '60 min', price: 150 },
    { id: '5', name: 'General Checkup', duration: '30 min', price: 50 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>AC Repair Services</Text>
            </View>
