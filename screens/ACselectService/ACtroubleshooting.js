...
// Sample data for AC troubleshooting services
const services = [
    { id: '1', name: 'Basic Troubleshooting', duration: '30 min', price: 50 },
    { id: '2', name: 'Advanced Troubleshooting', duration: '60 min', price: 100 },
    { id: '3', name: 'Diagnostics Check', duration: '45 min', price: 75 },
];

const ACtroubleshooting = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>AC Troubleshooting Services</Text>
            </View>
...
export default ACtroubleshooting;
