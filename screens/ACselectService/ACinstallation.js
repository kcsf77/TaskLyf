...
// Sample data for AC installation services
const services = [
    { id: '1', name: 'Window AC Installation', duration: '60 min', price: 150 },
    { id: '2', name: 'Split AC Installation', duration: '90 min', price: 250 },
    { id: '3', name: 'Central AC Installation', duration: '120 min', price: 500 },
];

const ACinstallation = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>AC Installation Service</Text>
            </View>
