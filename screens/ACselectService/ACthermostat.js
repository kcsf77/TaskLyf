...
// Sample data for AC thermostat services
const services = [
    { id: '1', name: 'Thermostat Installation', duration: '60 min', price: 150 },
    { id: '2', name: 'Thermostat Calibration', duration: '45 min', price: 100 },
    { id: '3', name: 'Thermostat Repair', duration: '30 min', price: 80 },
];

const ACthermostat = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>AC Thermostat Services</Text>
            </View>
