...
// Sample data for deep cleaning services
const services = [
    { id: '1', name: 'Living Room Deep Clean', duration: '2 hours', price: 120 },
    { id: '2', name: 'Kitchen Deep Clean', duration: '3 hours', price: 150 },
    { id: '3', name: 'Bedroom Deep Clean', duration: '1.5 hours', price: 100 },
];

const DeepCleaning = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Deep Cleaning Services</Text>
            </View>
