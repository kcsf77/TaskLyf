...
// Sample data for upholstery cleaning services
const services = [
    { id: '1', name: 'Sofa Cleaning', duration: '2 hours', price: 120 },
    { id: '2', name: 'Chair Cleaning', duration: '1 hour', price: 80 },
    { id: '3', name: 'Cushion Cleaning', duration: '1.5 hours', price: 100 },
];

const Upholstery = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Upholstery Cleaning Services</Text>
            </View>
