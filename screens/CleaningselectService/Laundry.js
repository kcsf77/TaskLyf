...
const services = [
    { id: '1', name: 'Wash and Fold', duration: '2 hours', price: 50 },
    { id: '2', name: 'Dry Cleaning', duration: '3 hours', price: 100 },
    { id: '3', name: 'Ironing', duration: '1 hour', price: 30 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Laundry and Ironing Services</Text>
            </View>
