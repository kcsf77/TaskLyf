...
// Sample data for standard cleaning services
const services = [
    { id: '1', name: 'Basic Standard Cleaning', duration: '2 hours', price: 100 },
    { id: '2', name: 'Deep Standard Cleaning', duration: '4 hours', price: 200 },
    { id: '3', name: 'Comprehensive Standard Cleaning', duration: '3 hours', price: 150 },
];

const StandardCleaning = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Standard Cleaning Services</Text>
            </View>
