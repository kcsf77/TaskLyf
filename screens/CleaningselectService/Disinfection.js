...
// Sample data for disinfection services
const services = [
    { id: '1', name: 'Home Disinfection', duration: '2 hours', price: 100 },
    { id: '2', name: 'Office Disinfection', duration: '3 hours', price: 150 },
    { id: '3', name: 'Vehicle Disinfection', duration: '1 hour', price: 50 },
];

const Disinfection = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Disinfection and Sanitization Services</Text>
            </View>
