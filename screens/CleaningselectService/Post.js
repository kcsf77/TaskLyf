...
// Sample data for post-construction cleaning services
const services = [
    { id: '1', name: 'Basic Post-Construction Cleaning', duration: '2 hours', price: 90 },
    { id: '2', name: 'Deep Post-Construction Cleaning', duration: '4 hours', price: 180 },
    { id: '3', name: 'Final Touch-Up Cleaning', duration: '3 hours', price: 150 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Post-Construction Cleaning Services</Text>
            </View>
