...
// Sample data for window cleaning services
const services = [
    { id: '1', name: 'Interior Window Cleaning', duration: '1 hour', price: 50 },
    { id: '2', name: 'Exterior Window Cleaning', duration: '1.5 hours', price: 70 },
    { id: '3', name: 'Full Window Cleaning', duration: '2 hours', price: 100 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Window Cleaning Services</Text>
            </View>
