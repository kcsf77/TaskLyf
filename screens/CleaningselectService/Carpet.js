...
// Sample data for carpet cleaning services
const services = [
    { id: '1', name: 'Basic Carpet Cleaning', duration: '30 min', price: 50 },
    { id: '2', name: 'Deep Carpet Cleaning', duration: '60 min', price: 100 },
    { id: '3', name: 'Stain Removal', duration: '45 min', price: 75 },
];

const Carpet = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Carpet Cleaning Services</Text>
            </View>
