...
// Sample data for move-in/move-out cleaning services
const services = [
    { id: '1', name: 'Basic Move-in Cleaning', duration: '2 hours', price: 80 },
    { id: '2', name: 'Deep Move-in Cleaning', duration: '4 hours', price: 150 },
    { id: '3', name: 'Post-Move-out Cleaning', duration: '3 hours', price: 120 },
];

const MoveinCleaning = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Move-in/Move-out Cleaning Services</Text>
            </View>
