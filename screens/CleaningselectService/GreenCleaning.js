...
// Sample data for green cleaning services
const services = [
    { id: '1', name: 'Eco-Friendly Home Cleaning', duration: '2 hours', price: 120 },
    { id: '2', name: 'Natural Carpet Cleaning', duration: '3 hours', price: 150 },
    { id: '3', name: 'Organic Disinfection', duration: '1 hour', price: 100 },
];

const GreenCleaning = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Green Cleaning Services</Text>
            </View>
