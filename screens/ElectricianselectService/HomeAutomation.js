...
// Sample data for home automation services
const services = [
    { id: '1', name: 'Smart Lighting Installation', duration: '1 hour', price: 100 },
    { id: '2', name: 'Thermostat Installation', duration: '1.5 hours', price: 150 },
    { id: '3', name: 'Security Camera Installation', duration: '2 hours', price: 250 },
];

const HomeAutomation = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Home Automation Services</Text>
            </View>
