...
// Sample data for smoke and carbon monoxide detector installation services
const services = [
    { id: '1', name: 'Smoke Detector Installation', duration: '1 hour', price: 100 },
    { id: '2', name: 'Carbon Monoxide Detector Installation', duration: '1 hour', price: 100 },
    { id: '3', name: 'Combined Smoke and Carbon Monoxide Detector Installation', duration: '2 hours', price: 180 },
];

const Smoke = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Smoke & CO Detector Services</Text>
            </View>
