...
// Sample data for outlet services
const services = [
    { id: '1', name: 'Standard Outlet Replacement', duration: '30 minutes', price: 50 },
    { id: '2', name: 'GFCI Outlet Installation', duration: '45 minutes', price: 70 },
    { id: '3', name: 'USB Outlet Installation', duration: '1 hour', price: 90 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Outlet and Switch Replacement Services</Text>
            </View>
