...
// Sample data for surge protection installation services
const services = [
    { id: '1', name: 'Basic Surge Protector Installation', duration: '1 hour', price: 150 },
    { id: '2', name: 'Advanced Surge Protection System', duration: '2 hours', price: 300 },
];

const Surge = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Surge Protection Services</Text>
            </View>
