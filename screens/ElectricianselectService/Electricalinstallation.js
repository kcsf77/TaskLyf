...
// Sample data for electrical installation services
const services = [
    { id: '1', name: 'Wiring Installation', duration: '1 day', price: 250 },
    { id: '2', name: 'Switch Installation', duration: '2 hours', price: 100 },
    { id: '3', name: 'Fuse Box Replacement', duration: '3 hours', price: 300 },
];

const ElectricalInstallation = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Electrical Installation Services</Text>
            </View>
