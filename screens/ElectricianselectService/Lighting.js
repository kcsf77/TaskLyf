...
// Sample data for lighting services
const services = [
    { id: '1', name: 'LED Lighting Installation', duration: '1 hour', price: 80 },
    { id: '2', name: 'Chandelier Installation', duration: '1.5 hours', price: 120 },
    { id: '3', name: 'Outdoor Lighting Setup', duration: '2 hours', price: 200 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Lighting Installation Services</Text>
            </View>
