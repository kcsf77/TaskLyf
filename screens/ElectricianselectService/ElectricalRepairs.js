...
// Sample data for electrical repair services
const services = [
    { id: '1', name: 'Outlet Repair', duration: '1 hour', price: 150 },
    { id: '2', name: 'Light Fixture Repair', duration: '2 hours', price: 200 },
    { id: '3', name: 'Circuit Breaker Replacement', duration: '3 hours', price: 350 },
];

const ElectricalRepairs = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Electrical Repairs Services</Text>
            </View>
