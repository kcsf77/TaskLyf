...
// Sample data for wiring upgrade services
const services = [
    { id: '1', name: 'Basic Wiring Upgrade', duration: '2 hours', price: 200 },
    { id: '2', name: 'Complete Home Wiring Upgrade', duration: '5 hours', price: 800 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Wiring Upgrade Services</Text>
            </View>
