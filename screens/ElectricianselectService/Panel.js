...
// Sample data for panel upgrade services
const services = [
    { id: '1', name: 'Standard Panel Upgrade', duration: '1 hour', price: 200 },
    { id: '2', name: 'Advanced Panel Upgrade', duration: '2 hours', price: 400 },
    { id: '3', name: 'Smart Panel Installation', duration: '3 hours', price: 600 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Panel Upgrade Services</Text>
            </View>
