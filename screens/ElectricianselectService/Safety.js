...
// Sample data for safety inspection services
const services = [
    { id: '1', name: 'Basic Safety Inspection', duration: '1 hour', price: 150 },
    { id: '2', name: 'Comprehensive Safety Inspection', duration: '2 hours', price: 300 },
    { id: '3', name: 'Annual Safety Compliance Check', duration: '3 hours', price: 500 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Safety Inspection Services</Text>
            </View>
