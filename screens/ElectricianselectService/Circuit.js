...
// Sample data for circuit installation and repair services
const services = [
    { id: '1', name: 'Wiring Installation', duration: '1 day', price: 200 },
    { id: '2', name: 'Circuit Breaker Replacement', duration: '2 hours', price: 150 },
    { id: '3', name: 'Socket Installation', duration: '1 hour', price: 100 },
];

const Circuit = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Circuit Installation and Repair Services</Text>
            </View>
