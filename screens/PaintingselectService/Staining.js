...
// Sample data for staining and varnishing services
const services = [
    { id: '1', name: 'Wood Staining', duration: '1 day', price: 300 },
    { id: '2', name: 'Furniture Varnishing', duration: '2 days', price: 500 },
    { id: '3', name: 'Deck Staining', duration: '3 days', price: 600 },
];

const Staining = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Staining and Varnishing Services</Text>
            </View>
