...
// Sample data for deck and fence painting services
const services = [
    { id: '1', name: 'Deck Staining', duration: '1 day', price: 250 },
    { id: '2', name: 'Fence Painting', duration: '2 days', price: 400 },
    { id: '3', name: 'Deck Painting', duration: '3 days', price: 600 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Deck and Fence Painting or Staining Services</Text>
            </View>
