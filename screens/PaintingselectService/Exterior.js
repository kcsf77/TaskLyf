...
// Sample data for exterior painting services
const services = [
    { id: '1', name: 'Exterior Wall Painting', duration: '3 days', price: 800 },
    { id: '2', name: 'Window Trim Painting', duration: '2 days', price: 500 },
    { id: '3', name: 'Door Painting', duration: '1 day', price: 300 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Exterior Painting Services</Text>
            </View>
