...
// Sample data for cabinet painting services
const services = [
    { id: '1', name: 'Basic Cabinet Painting', duration: '1 day', price: 200 },
    { id: '2', name: 'Cabinet Refinishing', duration: '2 days', price: 400 },
    { id: '3', name: 'Custom Cabinet Painting', duration: '3 days', price: 600 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Cabinet Painting and Refinishing Services</Text>
            </View>
