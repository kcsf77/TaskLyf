...
// Sample data for wall preparation services
const services = [
    { id: '1', name: 'Wall Cleaning', duration: '1 day', price: 150 },
    { id: '2', name: 'Drywall Repair', duration: '2 days', price: 300 },
    { id: '3', name: 'Patching and Priming', duration: '1 day', price: 250 },
];

const Wallpreparation = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Wall Preparation Services</Text>
            </View>
