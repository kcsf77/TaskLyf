...
// Sample data for texture painting services
const services = [
    { id: '1', name: 'Textured Wall Painting', duration: '1 day', price: 350 },
    { id: '2', name: 'Stucco Application', duration: '2 days', price: 700 },
    { id: '3', name: 'Popcorn Ceiling Removal', duration: '3 days', price: 800 },
];

const Texture = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Texture Painting Services</Text>
            </View>
