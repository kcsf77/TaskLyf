...
// Sample data for accent wall painting services
const services = [
    { id: '1', name: 'Accent Wall Painting', duration: '1 day', price: 150 },
    { id: '2', name: 'Custom Accent Wall', duration: '2 days', price: 300 },
    { id: '3', name: 'Accent Wall with Wallpaper', duration: '1 day', price: 250 },
];

const Accent = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Accent Wall Painting Services</Text>
            </View>
