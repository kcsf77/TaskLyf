...
// Sample data for wallpaper removal and painting services
const services = [
    { id: '1', name: 'Wallpaper Removal', duration: '1 day', price: 200 },
    { id: '2', name: 'Wall Painting', duration: '2 days', price: 350 },
    { id: '3', name: 'Wallpaper Installation', duration: '3 days', price: 500 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Wallpaper Removal and Painting Services</Text>
            </View>
