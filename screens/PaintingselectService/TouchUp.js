...
// Sample data for touch-up and repair services
const services = [
    { id: '1', name: 'Wall Touch-up', duration: '1 day', price: 150 },
    { id: '2', name: 'Ceiling Repair', duration: '2 days', price: 300 },
    { id: '3', name: 'Trim Touch-up', duration: '1 day', price: 100 },
];

const TouchUp = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Touch-up and Repair Services</Text>
            </View>
