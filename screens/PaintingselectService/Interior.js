...
// Sample data for interior painting services
const services = [
    { id: '1', name: 'Living Room Painting', duration: '2 days', price: 500 },
    { id: '2', name: 'Bedroom Painting', duration: '1 day', price: 300 },
    { id: '3', name: 'Kitchen Cabinet Painting', duration: '3 days', price: 700 },
];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Interior Painting Services</Text>
            </View>
